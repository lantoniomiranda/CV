...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty(trim($_POST["type_user"]))){
        $type_err = "Please select a type of user.";
    }else{
        $type = strval($_POST["type_user"]);
    }
                            ...
                            <div class="col-md-6 col-lg-12 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                        ...
                                        <!-- User Type Input -->
                                        <div class="form-outline mb-3">
                                            <select aria-label="Default select example" name="type_user" class="form-select <?php echo (!empty($type_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $type; ?>">
                                                <option selected>Select a type of user</option>
